            ...
            >
              <div className="flip-card-inner">
                ...
                <Card className={cn(
                  ...
                  "bg-gradient-to-br from-primary/15 via-card/20 to-primary/15 border border-accent/30 backdrop-blur-md",
                ...
                <Card className={cn(
                  ...
                  "bg-card/20 backdrop-blur-md border border-accent shadow-glow"
                )}>
                  {cardImages[card.id] && (
                    <img 
